		...
		<div class="span6 offset1 well">
			<form action="${ config.issuer }${ config.issuer.endsWith('/') ? '' : '/' }login" method="POST">
				...
				<div>
					<div class="input-prepend input-block-level">
						<span class="add-on"><i class="icon-lock"></i></span>
						<input type="text" placeholder="<spring:message code="login.otptoken"/>" autocorrect="off" autocapitalize="off" autocomplete="off" spellcheck="false" id="j_otp_token" name="otp_token">
					</div>
				</div>
				<div>
